    ...
    <div class="row gutters">
      ...
      <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
        @if(!empty($productUnit))
          {!! Form::open(array('route' =>['productUnits.update', $productUnit->id],'method'=>'PUT','files'=>true)) !!}
          <?php $info ="Update";?>
        @else
        {!! Form::open(array('route' =>['productUnits.store'],'method'=>'POST','files'=>true)) !!}
          <?php $info ="Add";?>
        @endif
        <div class="card">
          <div class="card-header">
            <div class="card-title">{{$info}} Product Unit</div>
          </div>
          <div class="card-body">
            <!-- Row start -->
            <div class="row gutters">
              <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                ...
                <div class="field-wrapper">
                  <div class="input-group">
                    ...
                    type="text" 
                    name="title" 
                    value="{{(!empty($productUnit->title))?$productUnit->title:''}}" 
                    placeholder="units"
                    required="" 
                    autocomplete="off">
                  </div>
              ...
              <table id="dataTable" class="table v-middle">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="actions">
                        <a href="{{ route('productUnits.edit', $productUnit->id) }}" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit">
                          <i class="icon-edit1 text-info"></i>
                        </a>
                        {{Form::open(array('route'=>['productUnits.destroy',$productUnit->id],'method'=>'DELETE'))}}
