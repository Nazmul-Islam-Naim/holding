...
<div class="content-wrapper-scroll">
  ...
  <div class="content-wrapper">
    ...
    <div class="row gutters">
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card">
          {!! Form::open(array('route' =>['products.update', $product->id],'method'=>'PUT','files'=>true)) !!}
              ...
              <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                <div class="field-wrapper">
                  ...
                  required="">
                    ...
                    <option value="{{$productCategory->id}}" {{($productCategory->id == $product->product_category_id)?'selected':''}}>{{$productCategory->title}}</option>
                    @endforeach
                  </select>
              ...
              <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                <div class="field-wrapper">
                  ...
                  required="">
                    ...
                    <option value="{{$productUnit->id}}" {{($productUnit->id == $product->product_unit_id)?'selected':''}}>{{$productUnit->title}}</option>
                    @endforeach
                  </select>
              ...
              <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                <div class="field-wrapper">
                  ...
                  required="">
                    ...
                    <option value="{{$productBrand->id}}" {{($productBrand->id == $product->product_brand_id)?'selected':''}}>{{$productBrand->title}}</option>
                    @endforeach
                  </select>
