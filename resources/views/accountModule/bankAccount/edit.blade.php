...
<div class="content-wrapper-scroll">
  ...
  <div class="content-wrapper">
    ...
    <div class="row gutters">
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card">
          {!! Form::open(array('route' =>['bankAccounts.update',$bankAccount->id],'method'=>'PUT','files'=>true)) !!}
            ...
            <div class="row gutters">
              ...
              <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                <div class="field-wrapper">
                  ...
                  required="">
                    ...
                    <option value="{{$bank->id}}" {{($bank->id == $bankAccount->bank_id)?'selected':''}}>{{$bank->title}}</option>
                    @endforeach
                  </select>
              ...
              <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                <div class="field-wrapper">
                  ...
                  required="">
                    ...
                    <option value="{{$accountType->id}}" {{($accountType->id == $bankAccount->account_type_id)?'selected':''}}>{{$accountType->title}}</option>
                    @endforeach
                  </select>
              ...
              <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                <div class="field-wrapper">
                  ...
                  value="{{$bankAccount->account_name ?? old('account_number')}}" 
                  autocomplete="off"
              ...
              <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                <div class="field-wrapper">
                  ...
                  value="{{$bankAccount->account_number ?? old('account_number')}}" 
                  autocomplete="off"
              ...
              <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                <div class="field-wrapper">
                  ...
                  value="{{$bankAccount->routing_number ?? old('routing_number')}}" 
                  autocomplete="off"
              ...
              <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                <div class="field-wrapper">
                  ...
                  value="{{$bankAccount->branch ?? old('branch')}}" 
                  autocomplete="off"
              ...
              <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                <div class="field-wrapper">
                  ...
                  value="{{$bankAccount->balance ?? old('balance')}}" 
                  autocomplete="off"
                  placeholder="255689"
                  required>
              ...
              <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                <div class="field-wrapper">
                  ...
                  value="{{$bankAccount->opening_date ?? date('Y-m-d')}}" 
                  autocomplete="off"
                  required>
