      ...
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card card-primary">
          <div class="card-header d-flex justify-content-between align-items-center">
              ...
              <a href="{{route('bankAccounts.create')}}" class="btn btn-primary btn-sm"><i class="icon-plus-circle"></i> Add Account</a>
            </div>
          <!-- /.box-header -->
          <div class="card-body">
            <div class="row">
                  ...
                  <table class="table table-bordered cell-border compact hover nowrap order-column row-border stripe" id="example"> 
                    <thead> 
                      <tr class="dt-top"> 
                        ...
                        <th class="dt-wrap">Opening Date</th> 
                        <th class="dt-wrap">Account Name</th>
                        <th class="dt-wrap">Account Number</th> 
                        <th class="dt-wrap">Account Type</th> 
                        <th class="dt-wrap">Bank</th> 
                        <th class="dt-wrap">Balance</th> 
...
<script>
  ...
  function dateFormat(data) { 
    ...
    $("#example").on("click", ".button-delete", function(e) {
        ...
        var id = $(this).data('id');
        var link = '{{route("bankAccounts.destroy",":id")}}';
