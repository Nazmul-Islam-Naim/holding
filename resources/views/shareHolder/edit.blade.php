...
<div class="content-wrapper-scroll">
  ...
  <div class="content-wrapper">
    ...
    <div class="row gutters">
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card">
          {!! Form::open(array('route' =>['shareHolders.update', $shareHolder->id],'method'=>'PUT','files'=>true)) !!}
          <div class="card-header">
            <div class="card-title">Update Shareholder Informations</div>
          </div>
            ...
            <div class="row gutters">
              ...
              <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                <div class="field-wrapper">
                  ...
                  value="{{$shareHolder->name ?? old('name')}}" 
                  autocomplete="off"
              ...
              <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                <div class="field-wrapper">
                  ...
                  value="{{$shareHolder->phone ?? old('phone')}}" 
                  autocomplete="off"
              ...
              <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                <div class="field-wrapper">
                  ...
                  value="{{$shareHolder->mail ?? old('mail')}}" 
                  autocomplete="off"
              ...
              <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="field-wrapper">
                  ...
                  {{ $shareHolder->details ?? old('details') }}
                </textarea>
