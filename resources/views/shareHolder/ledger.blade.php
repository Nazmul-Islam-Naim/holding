...
@section('title', 'Shareholder Ledger')
@section('content')
@php
      ...
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card card-primary">
          <div class="card-header d-flex justify-content-between align-items-center">
            <h3 class="card-title">Shareholder Ledger</h3>
          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-md-12" id="printReport">
                <center><h5 style="margin: 0px">Shareholder Information</h5></center>
                <div class="table-responsive">
                  <table class="" style="width: 100%; font-size: 12px;" cellspacing="0" cellpadding="0">
                    <thead> 
                      <tr> 
                        <td style="border: 1px solid #ddd; padding: 3px 3px">Share Name</td>
                        <td colspan="3" style="border: 1px solid #ddd; padding: 3px 3px">{{$shareHolder->name}}</td>
  
                        <td style="border: 1px solid #ddd; padding: 3px 3px">Phone</td>
                        <td colspan="3" style="border: 1px solid #ddd; padding: 3px 3px">{{$shareHolder->phone}}</td>
                      </tr>
                      <tr> 
                        <td style="border: 1px solid #ddd; padding: 3px 3px">Email</td>
                        <td colspan="3" style="border: 1px solid #ddd; padding: 3px 3px">{{$shareHolder->mail}}</td>
  
                        <td style="border: 1px solid #ddd; padding: 3px 3px">Address</td>
                        <td colspan="3" style="border: 1px solid #ddd; padding: 3px 3px">{{$shareHolder->address}}</td>
                      </tr>
                    </thead>
                  </table>
                </div>
                <center><h5 style="margin: 0px">Shareholder Ledger</h5></center>
