  ...
  <div class="content-wrapper">
    ...
    <div class="row gutters">
      ...
      <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
        @if(!empty($type))
          {!! Form::open(array('route' =>['types.update', $type->id],'method'=>'PUT','files'=>true)) !!}
          <?php $info ="Update";?>
        @else
        {!! Form::open(array('route' =>['types.store'],'method'=>'POST','files'=>true)) !!}
          <?php $info ="Add";?>
        @endif
        <div class="card">
          <div class="card-header">
            <div class="card-title">{{$info}} Voucher Type</div>
          </div>
          <div class="card-body">
            <!-- Row start -->
            <div class="row gutters">
              <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                ...
                <div class="field-wrapper">
                  <div class="input-group">
                    ...
                    type="text" 
                    name="title" 
                    value="{{(!empty($type->title))?$type->title:''}}" 
                    placeholder="convince bill"
                    required="" 
                    autocomplete="off">
                  </div>
      ...
      <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12">
        <div class="card">
          <div class="card-header">
            <div class="card-title">Voucher Types</div>
          </div>
          <div class="card-body">
              ...
              <table id="dataTable" class="table v-middle">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="actions">
                        <a href="{{ route('types.edit', $type->id) }}" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit">
